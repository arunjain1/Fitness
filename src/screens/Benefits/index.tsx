...
import { BenefitType, SelectedPage } from '../../CommonTypes/types';
...
function Benefits({setSelectedPage}: Props) {
  return (
    ...
    >
     <motion.div onViewportEnter={()=> setSelectedPage(SelectedPage.Benefits)} initial='hidden' whileInView='visible' viewport={{once : true,amount : 0.5}} transition={{duration:0.5}} variants={{
     ...
     {/* Graphics and Description */}
      ...
      <div className='mt-16 items-center justify-between gap-20 md:flex md:mt-28'>
         {/* Graphic */}
         <img className='mx-auto' alt="benefits-page-graphics" src={BenefitPageGraphic}/>
         {/* Description */}
         <div>
